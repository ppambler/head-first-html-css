...
从宏观的角度（3万英尺的高度下）看Web，**✎：**

![1543546139774](img/1543546139774.png)
...
![1543546208872](img/1543546208872.png)

![1541172404137](img/1541172404137.png)

## ★Web浏览器能做什么？

浏览器提供了一个可以让用户在网上冲浪的平台，如打开浏览器，输入网址回车或者单击一个链接来访问某个页面，浏览器就会向Web服务器请求一个HTML页面，然后检索（retrieve）响应回来的这个页面，之后就会在你的浏览器窗口中显示该页面了！

![1543546514606](img/1543546514606.png)
...
> 显示：Display or Show
>
> 表现：Show out or Perform
>
> 显示：1.明显地表示 2.通讯中以图像方式显示信息
> 表现：1.表示出来；显现出来 2.故意显出自己的长处 3.名词指表示出来的行为、作风或言论
>
> **➹：[“表示”，“显示”，“表现”，"表明"和“演示”，这些动词有什么差别？ - Lerne chinese - italki Antworten](https://www.italki.com/question/235398?hl=de)**
>
> 所以display的翻译应该为显示，而不是表现，毕竟确实是显示了网页的信息，而通过CSS则可以表现（presentation ）出元素的样式行为，总之对CSS的关键词就是「表现」，即表现出来的样式，而不是说显示出来的样式……
...
3. 好的设计和布局对页面的可读性和可用性会有非常大的影响！
   ...
   > 我觉得可读性指的是页面表现效果是如何的，而可用性则是各种设备的兼容
